...
/**
 * Сервис для работы с бизнес-логикой студентов.
 * Содержит методы фильтрации, сортировки, поиска и нормализации данных.
 */
public class StudentService {
    ...
    /**
     * Фильтрует список студентов по заданному критерию.
     * Принимает любой StudentFilter — анонимный класс или лямбда.
     *
    ...
    /**
     * Фильтрация по подстроке в имени (без учета регистра).
     */
    ...
    /**
     * Фильтрация по фамилии (без учета регистра).
     */
    ...
    /**
     * Комбинированная фильтрация: по баллу И по подстроке в имени или фамилии.
     *
     * @param students  исходный список
     * @param minScore  минимальный балл
     * @param keyword   ключевое слово для поиска в имени или фамилии
     * @return отфильтрованный список
     */
     ...
     * Используется анонимный класс Comparator.
     */
    ...
    /**
     * Поиск студентов по ключевому слову в имени ИЛИ фамилии (без учета регистра).
     *
     * @param students исходный список
    ...
    /**
     * Нормализация данных:
     * - Приведение имени и фамилии к нижнему регистру
     * - Удаление лишних пробелов по краям (trim)
     *
     * @param students исходный список
     * @return новый список с нормализованными данными
     */
